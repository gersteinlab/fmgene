...
class fmri_gene_data(Dataset):
    def __init__(self, config, stage, mode):
        ...
        # to make them unify (either split and/or size), consider cross common and fmri_list and/or gene_list for data unification
        ...
        #self.gene_label = self.gene_label[['PTID', 'DXCURREN']]
